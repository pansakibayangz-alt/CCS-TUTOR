...
// Gradient colors for each category (kept in case you want different VMGO header gradients)
$gradients = [
            ...
            <div class="profile-avatar">
                <?php
                    ...
                    if (!empty($student['firstname'])) {
                        $initials = strtoupper(substr($student['firstname'],0,1) . (isset($student['surname'][0]) ? $student['surname'][0] : '') );
                    }
                    echo htmlspecialchars($initials);
                ?>
            </div>
            <div class="profile-meta">
                <h5><?= htmlspecialchars( ($student['firstname'] ?? 'Student') . ' ' . ($student['surname'] ?? '') ) ?></h5>
                <p class="mb-0">School ID: <span class="kv"><?= htmlspecialchars($student['school_id'] ?? '') ?></span></p>
                <p class="mb-0">Role: <span class="kv">Student</span></p>
            </div>
        </div>
    </div>
    ...
    <div class="vmgo-grid">
        ...
        <aside class="side-box">
            ...
            <ul class="list-unstyled mb-3" style="font-size:0.95rem;">
                <li class="mb-2"><a class="link-gold" href="student_view_courses.php">View Courses</a></li>
                <li class="mb-2"><a class="link-gold" href="student_progress.php">My Progress</a></li>
                <li class="mb-2"><a class="link-gold" href="student_feedback.php">Send Feedback</a></li>
                <li class="mb-2"><a class="link-gold" href="student_about.php">My Profile</a></li>
            </ul>

            <h6>Notes</h6>
            <p style="font-size:0.9rem; color:rgba(255,255,255,0.85)">
                Welcome back. Use the side links to navigate your courses and track your progress. The VMGO is shown for reference — keep it visible for orientation.
            </p>
